    ...
    <div className="grid grid-cols-1 md:grid-cols-2">
      <div className="flex flex-col justify-center pt-10 gap-5 text-center">
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold font-second2">
          {label1}{" "}
          <span className="font-pacifiko bg-clip-text text-transparent bg-gradient-to-l from-light to-primary">
            {label2}
          </span>{" "}
          {label3}
        </h1>
      ...
      <div className="flex min-h-[450px] justify-center relative ">
        <Image
          src={src}
          alt=""
          width={420}
